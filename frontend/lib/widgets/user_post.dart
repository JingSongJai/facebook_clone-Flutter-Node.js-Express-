...
class UserPost extends StatefulWidget {
  const UserPost({super.key, required this.post, this.isUserPost = false});
...
class _UserPostState extends State<UserPost> {
  String id = Get.find<AuthService>().user!.id;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: kIsWeb ? theme.secondary : theme.surface,
        borderRadius: kIsWeb ? BorderRadius.circular(10) : null,
      ),
      margin: const EdgeInsets.symmetric(
        vertical: kIsWeb ? 8 : 1,
        horizontal: kIsWeb ? 5 : 0,
      ),
      child: Column(
        ...
        children: [
          ...
          //Post images
          Visibility(
            visible: widget.post.imageUrls.isNotEmpty,
            child: ImageGrid(images: widget.post.imageUrls),
          ),
        ...
        children: [
          Obx(
            () => _buildActionButton(
              ...
              Image.asset(
                ...
                width: 35,
                height: 35,
                color: isLiked.value ? null : Colors.white,
              ),
              onTap:
                  isProcessing.value
                      ? null
          ...
          _buildActionButton(
            ...
            SvgPicture.asset(
              ...
              width: 24,
              colorFilter: ColorFilter.mode(theme.tertiary, BlendMode.srcIn),
            ),
            onTap: () async {
              await showModalBottomSheet(
                context: context,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Text(text, style: TextStyle(color: theme.tertiary, fontSize: 12)),
          ],
        ),
      ),
    );
